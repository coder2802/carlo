        ...
        <div class="profile_wrap">
          ...
          <form action="post_new_basic_info_task.jsp"  method="post">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" id="brand" type="text" name="brand_id">
            </div>
            <div class="form-group">
              <label class="control-label">Brand</label>
              <input class="form-control white_bg" id="brand" type="text" name="brand_name">
            </div>
            <div class="form-group">
              <label class="control-label">Model id</label>
              <input class="form-control white_bg" id="model" type="text" name="model_id">
            </div>
            <div class="form-group">
              <label class="control-label">Model </label>
              <input class="form-control white_bg" id="model" type="text" name="model_name">
            </div>
            <div class="form-group">
              <label class="control-label">Model type </label>
              <input class="form-control white_bg" id="model" type="text" name="model_type">
            </div>
            
              <div class="form-group">
              <label class="control-label">Variant id</label>
              <input class="form-control white_bg" id="variant" type="text" name="variant_id">
            </div>
             <div class="form-group">
              <label class="control-label">Variant</label>
              <input class="form-control white_bg" id="variant" type="text" name="variant_name">
            </div>
            
            <div class="form-group">
              <label class="control-label">Price</label>
              <input class="form-control white_bg" id="Price" type="text" name="variant_price">
            </div>
                  
              <input type="text" name="form_no" value="1" hidden="true"/>
             
            <div class="form-group">
              
            <div class="form-group">
              <button type="submit" class="btn">Continue <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
