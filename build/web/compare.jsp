...
<!--Compare-->
 <div class="compare_car">
                ...
                <h3>Add Cars to Compare</h3>
                <form action="compare-item.jsp" method="post">
                    
            <div class="compare_box1">
                <div class="image_div">

                </div>            
                <div class="choose_car">
                    <div class="select_brand">
                        <select id="brand1" name="car_brand1" onchange="display_model1(this.value)">
                            <option value="select brand">Select Brand</option>
                             <jsp:include page="fetch_brand.jsp"></jsp:include>
                   </select>
                    </div>
                    <div class="select_model">
                        <select   id="model1" name="car_model1" onchange="display_variant1(this.value)" >
                          </select>
                    
                    </div>

                     <div class="select_varient">
                        <select id="variant1" name="car_variant1" >
            ...
            <div class="compare_box2">
                ...
                <div class="choose_car">
                    <div class="select_brand">
                         <select id="brand2" name="car_brand2" onchange="display_model2(this.value)" >
                             <option value="select brand">Select Brand</option>
                    ...
                    <div class="select_model">
                        <select id="model2" name="car_model2" onchange="display_variant2(this.value)">
                     ...
                     <div class="select_varient">
                        <select id="variant2" name="car_variant2">
                        </select>
