...
<!-- Mirrored from themes.webmasterdriver.net/carforyou/demo/dealers-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Mar 2018 17:19:31 GMT -->
<head>
...
<header>
  ...
  <!-- Navigation -->
   <jsp:include page="header.jsp"></jsp:include>  <!-- Navigation end --> 
...
<section class="inner_pages">
  <div class="container">
      ...
      <%
          Object user_id_buyer=session.getAttribute("user_id");
          ...
          try
          {
              Class.forName("com.mysql.jdbc.Driver");
                 ...
                 sql="select * from ads_master where city=? and car_brand=? and car_model=?";
                       }
                    else
                    {
                         user_id_buy=(Integer)user_id_buyer;
                        sql="select * from ads_master where city=? and car_brand=? and car_model=? and user_id!=?";
                    }
                ...
                if(user_id_buy!=0)
                {
                ps.setInt(4, user_id_buy);
                }
                ResultSet rs=ps.executeQuery();
                while(rs.next())
                {
                    String car_brand_name="";
                    String sql1="select brand_name from brand_master where brand_id=?";
                    PreparedStatement ps1=con.prepareStatement(sql1);
                    ps1.setString(1,car_brand);
                    ResultSet rs1=ps1.executeQuery();
                    if(rs1.next())
                    {
                        car_brand_name=rs1.getString("brand_name");
                    }
                    
                    String car_model_name="";
                    String sql2="select model_name from models_master where brand_id=? and model_id=?";
                    PreparedStatement ps2=con.prepareStatement(sql2);
                    ps2.setString(1,car_brand);
                    ps2.setString(2, car_model);
                    ResultSet rs2=ps2.executeQuery();
                    if(rs2.next())
                    {
                        car_model_name=rs2.getString("model_name");
                    }
                    
                    String car_variant_name="";
                    String sql3="select variant_name from variants_master where brand_id=? and model_id=?";
                    PreparedStatement ps3=con.prepareStatement(sql3);
                    ps3.setString(1,car_brand);
                    ps3.setString(2, car_model);
                    ResultSet rs3=ps3.executeQuery();
                    if(rs3.next())
                    {
                        car_variant_name=rs3.getString("variant_name");
                    }
      ...
      String image_url="";
                    String sql4="select image_url from adsimages_master where ad_id=?";
                    PreparedStatement ps4=con.prepareStatement(sql4);
                    ps4.setInt(1,ad_id);
                    ResultSet rs4=ps4.executeQuery();
                    if(rs4.next())
                    {
                        image_url=rs4.getString("image_url");
                    }
      ...
      <div class="dealers_listing">
        <div class="row">
          <div class="col-sm-3 col-xs-4">
            <div class="dealer_logo"> <a href="#"><img src="image_file/<%=image_url%>" alt="image"></a> </div>
          </div>
          <div class="col-sm-6 col-xs-8">
            <div class="dealer_info">
                
              <h5><a href="#">Autospot Used Cars Center </a></h5>
              <p><%=rs.getString("fuel_type")%><br>
                  <%=car_brand_name%></br>
                  <%=car_model_name%></br>
                  <%=car_variant_name%></br>
          ...
          <div class="col-sm-3 col-xs-12">
            <div class="view_profile">  
                ...
                <a href="sent-message.jsp?user_id=<%=rs.getInt("user_id")%>&car_brand1=<%=car_brand_name%>&car_model1=<%=car_model_name%>&car_variant1=<%=car_variant_name%>&ad_id=<%=ad_id%>" class="btn btn-xs outline">View Profile</a>
                <%
                ...
                %>
                    ...
                    <a href="home.jsp" class="btn btn-xs outline">View Profile</a>
               <%
                    }
                %>
              <p>(25 Cars)</p>
