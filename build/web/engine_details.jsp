...
<!-- Mirrored from themes.webmasterdriver.net/carforyou/demo/post-vehicle.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Mar 2018 17:17:42 GMT -->
<head>
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          ...
          <form action="post_new_basic_info_task.jsp"  method="post">
            ...
            <div class="gray-bg field-title">
              ...
              <input class="form-control white_bg" id="year" type="text" name="engine_id">
            </div>
            <div class="form-group">
              <label class="control-label">Engine Type</label>
              <input class="form-control white_bg" id="year" type="text" name="engine_type">
            </div>
            <div class="form-group">
              <label class="control-label">Engine Description</label>
              <input class="form-control white_bg" id="owners" type="text" name="engine_desc">
            </div>
            <div class="form-group">
              <label class="control-label">Displacement</label>
              <input class="form-control white_bg" id="kws" type="text" name="engine_displacement">
            </div>
            <div class="form-group">
              <label class="control-label">No of Cylinders</label>
              <input class="form-control white_bg" id="fuel" type="text" name="no_of_cylinders">
            </div>
            <div class="form-group">
              <label class="control-label">Max Power</label>
              <input class="form-control white_bg" id="color" type="text" name="max_power">
            </div>
              
               <div class="form-group">
              <label class="control-label">Max Toque</label>
              <input class="form-control white_bg" id="city" type="text" name="max_torque">
            </div>
           
            
               <div class="form-group">
              <label class="control-label">Fuel Supply System</label>
              <input class="form-control white_bg" id="city" type="text" name="fuel_supply_system">
            </div>
              <div>
                <input  type="checkbox" id="insurance" name="turbo_charger">
                <label for="insurance">Turbo Charger</label>
              </div>
            <div>
                <input  type="checkbox" id="insurance" name="super_charger">
                <label for="insurance">Super Charger</label>
              </div>
            <input type="text" name="form_no" value="2" hidden="true"/>
