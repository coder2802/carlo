...
<!-- Mirrored from themes.webmasterdriver.net/carforyou/demo/blog-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Mar 2018 17:20:00 GMT -->
<head>
        ...
        %>
              ...
              <li class="comment">
                <div class="comment-body">
                  <div class="comment-author">  <span class="fn"><%=rs.getString("username")%></span> </div>
                  <div class="comment-meta commentmetadata"> <a href="#"><%=rs.getString("review_date")%></a> </div>
  ...
  finally
  {
      ...
      catch(Exception e)
      {
        ...
        <div class="comment-respond">
          ...
          <form action="add_reviews.jsp" method="post" class="comment-form">
            <div class="form-group">
              <input  type="text" class="form-control" placeholder="Full Name" name="username">
            </div>
           
            <div class="form-group">
              <textarea class="form-control"  rows="4" placeholder="Comment" name="comment"></textarea>
            </div>
            <div class="form-group">
...
<!-- Mirrored from themes.webmasterdriver.net/carforyou/demo/blog-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Mar 2018 17:20:13 GMT -->
</html>