        ...
        <div class="profile_wrap">
          ...
          <form action="post_new_basic_info_task.jsp"  method="post">
            ...
            <div class="gray-bg field-title">
              ...
              <label class="control-label">Transmission Id</label>
              <input class="form-control white_bg" id="year" type="text" name="trans_id">
            </div>
            <div class="form-group">
              <label class="control-label">Transmission Type</label>
              <input class="form-control white_bg" id="year" type="text" name="trans_type">
            </div>
            <div class="form-group">
              <label class="control-label">Gear Box</label>
              <input class="form-control white_bg" id="owners" type="text" name="gear_box">
            </div>
            <div class="form-group">
              <label class="control-label">Drive Type</label>
              <input class="form-control white_bg" id="kws" type="text" name="drive_type">
            </div>
            
            <input type="text" name="form_no" value="3" hidden="true"/>
