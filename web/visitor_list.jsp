    ...
    <div class="result-sorting-wrapper">
      ...
      <%
          ...
          try
          {
                    ...
                    sql="select *  from interests_master where ad_id=?";
                    ...
                    while(rs.next())
                    {
                        ...
                        String sql1="select user_name ,user_email ,primary_contact from users_master where user_id=?";
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-xs-8">
            <div class="dealer_info">
              ...
              <h5><a href="#">Visitor Detail </a></h5>
              <p><br>
                  <%=rs1.getString("user_name")%></br>
                  <%=rs1.getString("user_email")%></br>
                  <%=rs1.getString("primary_contact")%></br>
